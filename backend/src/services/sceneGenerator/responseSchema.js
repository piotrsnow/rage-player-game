...
const SCENE_RESPONSE_SCHEMA = {
  ...
  schema: {
    ...
    properties: {
      ...
      questOffers: { type: 'array', items: { type: 'object' } },
      cutscene: {},
      dilemma: {},
      stateChanges: {
        type: 'object',
        properties: {
          ...
          questUpdates: { type: 'array', items: { type: 'object' } },
          objectiveReveals: { type: 'array', items: { type: 'object' } },
          branchGroupReveals: { type: 'array', items: { type: 'object' } },
          questMutations: { type: 'array', items: { type: 'object' } },
          completedQuests: { type: 'array', items: { type: 'object' } },
          npcs: { type: 'array', items: { type: 'object' } },
          npcMemoryUpdates: { type: 'array', items: { type: 'object' } },
          locationMentioned: { type: 'array', items: { type: 'object' } },
          ...
          removeItems: { type: 'array', items: { type: 'object' } },
          removeItemsByName: { type: 'array', items: { type: 'string' } },
