...
For stateChanges.skillsUsed: an array of skill names the PC used in this action, e.g. ["Walka bronia jednoręczna", "Uniki"]. Max 3 skills. Use [] if no skills were used.
For stateChanges.actionDifficulty: estimated difficulty of the PC's action: "easy", "medium", "hard", "veryHard", or "extreme". Use null for trivial/automatic actions.
