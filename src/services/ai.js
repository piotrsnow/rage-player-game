...
export const aiService = {
  ...
  async generateScene(gameState, dmSettings, playerAction, isFirstScene, provider, apiKey, language = 'en', enhancedContext = null, { needsSystemEnabled = false, isCustomAction = false } = {}) {
    const promptOpts = { needsSystemEnabled, characterNeeds: gameState.character?.needs || null, isCustomAction };
