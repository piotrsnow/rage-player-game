...
export default function KeysModal({ onClose }) {
  ...
  const { settings, updateSettings, updateDMSettings, hasApiKey, backendKeys, backendUser } = useSettings();
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12 py-8">
            ...
            {backendUser?.isAdmin && (
              <>
                ...
                <section className="mt-8 pt-6 border-t border-outline-variant/15 animate-fade-in">
