...
function SkillGainPreviewHeader({ gain, t }) {
...
export default function SkillGainHistory({ characterId, skillName }) {
  ...
  return (
    <>
      ...
      {selectedGain && (
        <ScenePreviewModal
          campaignId={selectedGain.campaignId}
          sceneIndex={selectedGain.sceneIndex}
          header={<SkillGainPreviewHeader gain={selectedGain} t={t} />}
          onClose={closeModal}
        />
      )}
    </>
