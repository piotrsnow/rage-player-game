...
export default function CampaignCard({ campaign, onLoad, onDelete, onTogglePublish, onShare, loading, disabled }) {
            ...
            <div className={`flex items-center gap-1 transition-all duration-300 ${
              ...
              {deleteState === 'idle' && (campaign.sceneCount || 0) > 0 && (
                <button
                  ...
                  className="p-1 rounded-sm text-outline hover:text-primary hover:bg-primary/10 transition-colors flex items-center justify-center"
                >
