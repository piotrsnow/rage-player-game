        ...
        <div className="space-y-3">
          ...
          <div className="relative">
              <button
                ...
                disabled={disabled || hasPendingAction}
                className="flex items-center gap-2 px-3 py-2 text-xs font-label text-error/80 hover:text-error bg-error/5 hover:bg-error/10 border border-error/10 hover:border-error/25 rounded-sm transition-all disabled:opacity-30 disabled:pointer-events-none"
              >
              ...
              {combatPickerOpen && (
                <div className="mt-2 p-3 bg-surface-container-high border border-outline-variant/20 rounded-sm space-y-2 animate-fade-in">
