...
export default function ScenePanel({
  ...
  if (!scene) {
    return (
      <div className="relative w-full h-[max(280px,66vh)] rounded-lg overflow-hidden border border-outline-variant/10 shadow-[0_0_40px_rgba(0,0,0,0.8)] bg-gradient-to-br from-surface-container-high via-surface-container to-surface-container-lowest flex items-center justify-center">
  ...
  return (
    <div data-testid="scene-panel" className="relative w-full h-[max(280px,66vh)] rounded-lg overflow-hidden border border-outline-variant/10 shadow-[0_0_40px_rgba(0,0,0,0.8)] animate-fade-in">
      {/* Dream overlay */}
