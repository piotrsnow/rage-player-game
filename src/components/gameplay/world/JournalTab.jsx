    ...
    <div className="space-y-4">
      {compressedHistory && (
        <div className="p-3 rounded-sm bg-primary/5 border border-primary/15">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-label uppercase tracking-widest text-primary">{t('worldState.archivedHistory')}</span>
          </div>
      ...
      {eventHistory.length > 0 && (
        <div className="space-y-2">
          <div className="text-xs font-label uppercase tracking-widest text-on-surface-variant px-1">{t('worldState.eventLog')}</div>
