// Shared dialogue repair: quote parser + speaker attribution.
// Used by FE (src/services/aiResponse/dialogueRepair.js re-export) and BE (multiplayerAI/sceneGeneration.js, campaignGeneration.js).
// Polish/English speech detection with fuzzy name matching, fallback speaker resolution,
// dialogue dedup, and player reattribution.

import { hasNamedSpeaker, isGenericSpeakerName } from './dialogueSpeaker.js';
